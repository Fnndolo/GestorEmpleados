 ...
 */
export type Editor = 'membrete' | 'autorizacion' | 'autorizacion-laboral' | 'cuentas-cobro'
export const EDITORES: readonly Editor[] = ['membrete', 'autorizacion', 'autorizacion-laboral', 'cuentas-cobro']
